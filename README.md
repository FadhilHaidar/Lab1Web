...
4. Ikuti langkah-langkah Praktikum yang akan dijelaskan berikutnya:
  ...
  Untuk menampilkan teks dalam bentuk paragraf pada halaman web, kita harus menggunakan tag p sebagai elemen pembuka dan penutup. Tag ini menginstruksikan browser agar teks yang berada di dalamnya ditampilkan sebagai satu kesatuan paragraf yang rapi. Mahasiswa dapat menuliskan beberapa kalimat yang saling mendukung di antara tag (p)...(/p), lalu menyimpan dan me-refresh halaman untuk melihat hasilnya.
  ...
  Untuk menghubungkan halaman web dengan halaman lain, mahasiswa harus menggunakan tag a dengan atribut href yang berisi URL tujuan. Tag ini memungkinkan pengguna mengklik teks tertentu untuk berpindah ke halaman lain, baik internal maupun eksternal. Atribut tambahan seperti target="_blank" dapat digunakan agar link terbuka di tab baru, meningkatkan kenyamanan navigasi.
...
5. Lakukan validasi dokumen html dengan mengakses http://validator.w3.org
  ...
  Mahasiswa wajib melakukan validasi dokumen HTML untuk memastikan struktur dan sintaks kode sudah sesuai standar W3C. Validasi dilakukan dengan mengakses situs W3C Validator dan mengunggah file HTML atau menyalin langsung kode ke kolom input. Hasil validasi akan menunjukkan kesalahan atau peringatan yang perlu diperbaiki agar halaman web tampil optimal di berbagai browser.
